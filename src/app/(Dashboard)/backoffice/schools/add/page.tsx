        ...
        <div className=" mb-14">
          {
            ...
            ? <SchoolInformation formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleInputChange={handleInputChange} />
            : currentView === "Program Information" ? <ProgramInformation formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleInputChange={handleInputChange} />
            : currentView === "Tuition and Fees" ? <TuitionAndFees formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleInputChange={handleInputChange} handleNumericInputChange={handleNumericInputChange} />
            : currentView === "Admission Requirement" ? <AdmissionRequirement formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleFlatArrayInputChange={handleFlatArrayInputChange} />
            : currentView === "Image" ? <SchoolImages formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleFlatArrayInputChange={handleFlatArrayInputChange} selectedData={selectedData} imageFiles={imageFiles} setImageFiles={setImageFiles} hasProcessedImages={hasProcessedImages} setHasProcessedImages={setHasProcessedImages} />
            : currentView === "Other Information" ? <OtherInformation formData={formData} setFormData={setFormData} isLoading={isLoading} isSubmitting={isSubmitting} handleFlatArrayInputChange={handleFlatArrayInputChange} handleInputChange={handleInputChange} />
            : "hello"
          }
        </div>
