...
export default function ProgramDetailsLoader({ params }: IProps) {
  ...
  return (
    <main className="bg-white h-screen relative z-[-3] flex flex-col justify-center items-center mb-[4vmin]">
      <div className="w-max z-[-2] h-auto aspect-square relative flex items-center justify-center p-4">
        ...
        <Image loading="lazy" width={250}  height={80} src="/images/logo-and-text.svg" alt="logo" className="animate-none z-[8] my-auto top-0 bottom-0" />
      </div>
    </main>
  );
}
